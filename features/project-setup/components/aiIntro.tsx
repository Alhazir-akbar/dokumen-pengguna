...
export default function AiIntro() {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-xl mx-auto pt-8 text-center">
      ...
      {/* List 5 Langkah AI */}
      <div className="bg-white/10 border border-blue-200/50 rounded-2xl p-6 w-full mb-8 text-left backdrop-blur-sm">
      ...
      <div className="w-full flex items-center justify-between">
        <button
          type="button"
          onClick={nextStep}
          className="bg-white text-blue-500 hover:bg-blue-50 px-3 py-2 rounded-xl font-semibold transition-all flex items-center gap-2 shadow-lg text-sm"
        >
        ...
        <button
          type="button"
          onClick={prevStep}
          className="text-blue-200 hover:text-white text-sm font-small transition-colors underline underline-offset-4"
        >
